...
| 编译器 | AppleClang, C++23 |
| 构建类型 | Release |
| 测试日期 | 2026-02-08（基线） / 2026-02-13（优化复测） |
...
5. **扩展性**: 小包场景连接数从 50 到 200，QPS 保持在 170K+ 水平；64KB 大包在 20~400 连接保持 6.5K~7.2K QPS 稳定
6. **大包优化效果**: 64KB 场景 QPS 达到 7K 级别，明显高于优化前不到 1K 的异常区间
